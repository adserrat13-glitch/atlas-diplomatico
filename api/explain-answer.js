...
A partir de uma questão de CERTO/ERRADO que o candidato errou, gere uma explicação didática em áudio (será lida por TTS).
Explique por que a resposta correta é CERTO ou ERRADO, de forma clara, objetiva e falada (2-4 frases, sem markdown, sem listas, texto corrido).
